 ...
 *          using n trapezoids.
 *
 * Compile with OpenMP: gcc -g -Wall -fopenmp -o omp_trap3 omp_trap3.c
 * Compile without OpenMP: gcc -g -Wall -o seq_trap3 seq_trap3.c
 * Usage for OpenMP:   ./omp_trap3 <number of threads>
 *
 * Notes:   
